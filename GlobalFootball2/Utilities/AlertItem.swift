...
enum AlertContext {
    ...
    static let invalidData      = AlertItem(title: Text("Server Error"),
                                            ...
                                            dismissButton: .default(Text("Ok")))
    static let invalidUsername      = AlertItem(title: Text("Server Error"),
                                            message: Text("The username submitted was invalid. Please try again or contact support."),
                                            dismissButton: .default(Text("Ok")))
    static let invalidPlayFreq =        AlertItem(title: Text("Playbook Error"),
                                          message: Text("The playcalling frequencies must add up to 100%"),
                                          dismissButton: .default(Text("Ok")))
}
